...
Table 1. Mandatory repository parameter:
[options="header"]
|=======================
...
Table 2. Optional parameters: (`?` followed by `keyword=value`)
[options="header"]
|=======================
...
__<{che-host}>__#__<repository_url>__?__<parameter_1>__&__<parameter_2>__

== Authoring an URL to start a workspace
